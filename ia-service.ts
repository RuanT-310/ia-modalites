...
export const generateSchedule = async (profile: UserProfile): Promise<ScheduleItem[]> => {
  ...
  const prompt = `Você é um especialista em fitness para idosos. Com base no perfil abaixo, crie um cronograma de exercícios para os próximos 7 dias.
...
Retorne APENAS um JSON array válido neste formato (sem markdown):
[{"date":"2024-12-06","exerciseId":"ex_001"},{"date":"2024-12-08","exerciseId":"ex_002"}]`;
